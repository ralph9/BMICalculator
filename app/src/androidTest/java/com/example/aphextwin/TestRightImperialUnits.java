...
public class TestRightImperialUnits {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void testRightImperialUnits() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("Units"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        ViewInteraction appCompatTextView2 = onView(
                allOf(withId(R.id.title), withText("Imperial"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.inputWeight), withText("200"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatTextView3 = onView(
                allOf(withId(R.id.textResult), withText("OVERWEIGHT"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
